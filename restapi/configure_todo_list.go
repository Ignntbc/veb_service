...
import (
	...
	"github.com/Ignntbc/veb_service/restapi/operations"
	"github.com/Ignntbc/veb_service/restapi/operations/hello"
)

//go:generate swagger generate server --target ..\..\veb_service --name TodoList --spec ..\swagger.yml --principal interface{}
